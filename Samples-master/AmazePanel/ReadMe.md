...
- The [AmazePanel](https://github.com/Adobe-CEP/Samples/tree/master/AmazePanel)
    sample project is exhaustive in its exercise of Premiere Pro's ExtendScript
    API. If you're reading this, you likely already _have_ the AmazePanel sample.
...
Put `/AmazePanel` or your own panel's containing directory here, to have Premiere
Pro load it:
